...
SET(WRAP_ITK_BOOL "")
IF(WRAP_bool)
  SET(WRAP_ITK_BOOL ${WRAP_ITK_BOOL} "B")
ENDIF(WRAP_bool)  
...
SET(WRAP_ITK_FIXED_VECTOR "")
FOREACH(type ${WRAP_ITK_USIGN_INT} ${WRAP_ITK_SIGN_INT} ${WRAP_ITK_REAL})
  SET(WRAP_ITK_FIXED_VECTOR ${WRAP_ITK_FIXED_VECTOR} "V${type}")
ENDFOREACH(type)

SET(WRAP_ITK_COV_VECTOR "")
FOREACH(type ${WRAP_ITK_USIGN_INT} ${WRAP_ITK_SIGN_INT} ${WRAP_ITK_REAL})
  SET(WRAP_ITK_COV_VECTOR ${WRAP_ITK_COV_VECTOR} "CV${type}")
ENDFOREACH(type)

SET(WRAP_ITK_VECTOR_IMAGE "")
FOREACH(type ${WRAP_ITK_USIGN_INT} ${WRAP_ITK_SIGN_INT} ${WRAP_ITK_REAL})
  SET(WRAP_ITK_VECTOR_IMAGE ${WRAP_ITK_VECTOR_IMAGE} "VI${type}")
ENDFOREACH(type)

#SET(WRAP_ITK_COMPLEX_REAL "")
#IF(WRAP_complex_double)
#  SET(WRAP_ITK_COMPLEX_REAL ${WRAP_ITK_VECTOR_REAL} "CD")
#ENDIF(WRAP_complex_double)
#IF(WRAP_complex_float)
#  SET(WRAP_ITK_COMPLEX_REAL ${WRAP_ITK_VECTOR_REAL} "CF")
#ENDIF(WRAP_complex_float)

SET(WRAP_ITK_MESH_PIXELS "")
FOREACH(type ${WRAP_ITK_REAL})
  SET(WRAP_ITK_MESH_PIXELS ${WRAP_ITK_MESH_PIXELS} "${type}")
ENDFOREACH(type)

SET(WRAP_ITK_INT ${WRAP_ITK_SIGN_INT} ${WRAP_ITK_USIGN_INT})
SET(WRAP_ITK_SCALAR ${WRAP_ITK_INT} ${WRAP_ITK_REAL} ${WRAP_ITK_BOOL})
SET(WRAP_ITK_SCALAR_NO_BOOL ${WRAP_ITK_INT} ${WRAP_ITK_REAL})
SET(WRAP_ITK_VECTOR ${WRAP_ITK_FIXED_VECTOR} ${WRAP_ITK_COV_VECTOR})
