WRAP_CLASS("itk::ImageRegistrationMethod")
  ...
  BEGIN_MANAGED_METHOD("StartOptimization")
    SET(MANAGED_METHOD_SUMMARY         "Method that initiates the optimization process.")
    SET(MANAGED_METHOD_RETURN_TYPE     "void")
    SET(MANAGED_METHOD_PARAMS          "void")
    SET(MANAGED_METHOD_TYPE_BODY       "try { m_PointerToNative->StartOptimization( ); } catch(itk::ExceptionObject& ex) { throw gcnew itkExceptionObject( ex.GetDescription(), ex.GetLocation(), ex.GetFile(), ex.GetLine() ); }")
    SET(MANAGED_METHOD_WRAPPER_BODY    "iInstance->StartOptimization();")
  END_MANAGED_METHOD()

  BEGIN_MANAGED_METHOD("Initialize")
    SET(MANAGED_METHOD_SUMMARY         "Initialize by setting the interconnects between the components.")
    SET(MANAGED_METHOD_RETURN_TYPE     "void")
    SET(MANAGED_METHOD_PARAMS          "void")
    SET(MANAGED_METHOD_TYPE_BODY       "try { m_PointerToNative->Initialize( ); } catch(itk::ExceptionObject& ex) { throw gcnew itkExceptionObject( ex.GetDescription(), ex.GetLocation(), ex.GetFile(), ex.GetLine() ); }")
    SET(MANAGED_METHOD_WRAPPER_BODY    "iInstance->Initialize();")
  END_MANAGED_METHOD()
