WRAP_CLASS("itk::SigmoidImageFilter")

  WRAP_IMAGE_FILTER_USIGN_INT(2)
  WRAP_IMAGE_FILTER_SIGN_INT(2)
  WRAP_IMAGE_FILTER_REAL(2)

  BEGIN_MANAGED_PROPERTY("Alpha" SET)
    SET(MANAGED_PROPERTY_SUMMARY   "Set the alpha value for the sigmoid function.")
  ...
  BEGIN_MANAGED_PROPERTY("Beta" SET)
    SET(MANAGED_PROPERTY_SUMMARY   "Set the beta value for the sigmoid function.")
    SET(MANAGED_PROPERTY_TYPE      "double")
  ...
  BEGIN_MANAGED_PROPERTY("OutputMinimum" SET)
    SET(MANAGED_PROPERTY_SUMMARY   "Get/set the output minimum value.")
    SET(MANAGED_PROPERTY_TYPE      "itkPixel^")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetOutputMinimum( itk::ManagedTypes::ToNativePixel<NativeType::OutputPixelType>( value ) );")
  END_MANAGED_PROPERTY()
  
  BEGIN_MANAGED_PROPERTY("OutputMaximum" SET)
    SET(MANAGED_PROPERTY_SUMMARY   "Get/set the output maximum value.")
    SET(MANAGED_PROPERTY_TYPE      "itkPixel^")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetOutputMaximum( itk::ManagedTypes::ToNativePixel<NativeType::OutputPixelType>( value ) );")
  END_MANAGED_PROPERTY()
