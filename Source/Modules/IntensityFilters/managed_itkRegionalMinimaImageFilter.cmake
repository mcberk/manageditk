WRAP_CLASS("itk::RegionalMinimaImageFilter")
  ...
  BEGIN_MANAGED_PROPERTY("FlatIsMinima" GETSET)
    SET(MANAGED_PROPERTY_SUMMARY   "Get/set if a flat image is be considered as a minima or not. The default is FlatIsMinima=True.")
    SET(MANAGED_PROPERTY_TYPE      "bool")
    SET(MANAGED_PROPERTY_GET_BODY  "return m_PointerToNative->GetFlatIsMinima();")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetFlatIsMinima( value );")
  END_MANAGED_PROPERTY()
