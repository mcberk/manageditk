WRAP_CLASS("itk::ScaleSkewVersor3DTransform")
  ...
  BEGIN_MANAGED_PROPERTY("Scale" GETSET)
    ...
    SET(MANAGED_PROPERTY_GET_BODY  "return itk::ManagedTypes::ToManagedVector<3>( m_PointerToNative->GetScale() );")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetScale( itk::ManagedTypes::ToNativeVector<3>(value) );")
  END_MANAGED_PROPERTY()

  BEGIN_MANAGED_PROPERTY("Skew" GETSET)
    SET(MANAGED_PROPERTY_SUMMARY   "Get/set the skew part of the transform (a six dimension vector).")
    SET(MANAGED_PROPERTY_TYPE      "itkVector^")
    SET(MANAGED_PROPERTY_GET_BODY  "return itk::ManagedTypes::ToManagedVector<6>( m_PointerToNative->GetSkew() );")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetSkew( itk::ManagedTypes::ToNativeVector<6>(value) );")
  END_MANAGED_PROPERTY()
