WRAP_CLASS("itk::QuaternionRigidTransform")
  ...
  BEGIN_MANAGED_PROPERTY("Rotation" GETSET)
    SET(MANAGED_PROPERTY_SUMMARY   "Get/set the rotation part of the transform (using a quaternion).")
    SET(MANAGED_PROPERTY_TYPE      "itkQuaternion^")
    SET(MANAGED_PROPERTY_GET_BODY  "return itk::ManagedTypes::ToManagedQuaternion( m_PointerToNative->GetRotation() );")
    SET(MANAGED_PROPERTY_SET_BODY  "m_PointerToNative->SetRotation( itk::ManagedTypes::ToNativeQuaternion(value) );")
